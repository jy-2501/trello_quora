...
public class AdminController {
    ...
    public ResponseEntity<Response> userDelete(@RequestHeader("authorization") String token,
                                                   @PathVariable("userId") String userId) throws Exception {
        try {
            return new ResponseEntity<Response>(userService.deleteUser(userId, token), HttpStatus.OK);
